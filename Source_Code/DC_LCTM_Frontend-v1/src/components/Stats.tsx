/**
 * Stats Component
 * Displays real-time statistics about cyber attacks including total counts,
 * severity breakdown, and top source/target countries
 */
...
const Stats: React.FC<StatsProps> = ({ attacks }) => {
  ...
  /**
   * Calculate attack counts by severity level
   */
  ...
  // Count attacks by source and target countries
