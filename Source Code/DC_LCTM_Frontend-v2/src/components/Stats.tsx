/**
 * Stats component that displays attack statistics and breakdowns
 * Shows total attacks, critical threats, top source/target countries, and severity distribution
 */
...
const Stats: React.FC<StatsProps> = ({ attacks }) => {
  ...
  // Calculate attacks by severity level
  ...
  // Calculate top source and target countries
  const sourceCountMap = new Map<string, number>();
  const targetCountMap = new Map<string, number>();

  attacks.forEach((attack) => {
    // Count source countries
