/**
 * WorldMap Component
 * Renders an interactive world map showing cyber attacks and malicious IPs
 * Uses react-simple-maps for map visualization and handles country hover interactions
 */
...
const WorldMap: React.FC<WorldMapProps> = ({
   ...
   * Finds the corresponding country data and calls the onCountryHover callback
   */
  ...
  return (
    <div className="relative w-full h-full bg-[#111827] rounded-lg overflow-hidden top-16">
      ...
      >
        <ZoomableGroup>
          {/* Clipping mask for the visible map area */}
          <defs>
          ...
          {/* Attack vectors layer with clipping mask */}
          ...
          {/* Malicious IP markers layer with clipping mask */}
          <g clipPath="url(#map-clip)">
